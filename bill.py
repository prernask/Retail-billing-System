...
def welcome():
    ...
    textarea.insert(END,"\t  Welcome Shivansh Retail")
...
title=Label(root,pady=2,text="Retail Billing System",bd=12,bg=bg_color,fg='white',font=('times new roman', 25 ,'bold'),relief=GROOVE,justify=CENTER)
title.pack(fill=X)
...
btn3=Button(F2,text='Clear Field',font='arial 15 bold',padx=5,pady=10,command=clear,bg='lime',width=15)
